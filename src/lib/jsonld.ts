...
export function softwareApplicationLd(tiers: Tier[]) {
  ...
  return {
    ...
    // page copy.
    description:
      "KINECT is a client portal for agencies, professional services firms and consultants, combining task tracking, analytics and AI insights. Flat pricing from " +
